            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label htmlFor="task-title" className="text-sm font-bold text-slate-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label htmlFor="task-link" className="text-sm font-bold text-slate-700">External Link URL (Optional)</label>
                  <input
                    id="task-link"
                    type="url"
